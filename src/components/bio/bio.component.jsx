  ...
  return (
    <Card className="bio">
        <Row gutter={[{xs: 4, sm: 4, md: 24, lg: 32},{xs: 4, sm: 4, md: 24, lg: 24}]}>
           <Col className="gutter-row" xs= {16} sm={16} md={6} lg={6} xl={6} xxl={6}>
             <img className="img-responsive img-thumbnail"
                  src={imageURL}
                  alt="me.jpg"
             />
           </Col>
           <Col className="gutter-row" xs= {16} sm={16} md={8} lg={8} xl={8} xxl={8}>
            <h1>{intro}</h1>
           ...
           <Col className="gutter-row" xs= {16} sm={16} md={12} lg={8} xl={8} xxl={8}>
